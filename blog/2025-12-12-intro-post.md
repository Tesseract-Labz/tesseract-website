...
| --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| AI agents payments                                  | Non existing                                                                                                                                        | <ol><li>Seemless integration</li><li>Payments speed depends on blockchain</li><li>Very low fees</li></ol>                                    | <ol><li>Seemless integration</li><li>Payments are instant</li><li>Very low fees</li><li>Lots of blockchains supported</li></ol> |
| Pay-per-use (ex. market research agent)             | <ol><li>Humans need to manually subscribe/buy credits to many API services</li><li>API keys setup required</li><li>API credits can expire</li></ol> | <ol><li>AI Agent pays for API services</li><li>No API key setup required</li><li>Payments speed depends on blockchain and low fees</li></ol> | <ol><li>Agent pays for API services</li><li>No API key setup required</li><li>Instant payments and low fees</li></ol>           |
| High frequency services                             | <ol><li>Humans need to manually subscribe/buy credits to the API service</li><li>API keys setup required</li><li>API credits can expire</li></ol>   | Non existing                                                                                                                                 | <ol><li>User pays for API services</li><li>No API key setup required</li><li>Instant payments and low fees</li></ol>            |
| Pay-per-access (ex. human wants to read an article) | <ol><li>Account registration required to make a subscription</li><li>Monthly/yearly subscription required to unlock paywall</li></ol>               | <ol><li>Pay with wallet and unlock paywall</li><li>No registration required</li></ol>                                                        | <ol><li>Pay with wallet and unlock paywall</li><li>No registration required</li><li>Instant payments and low fees</li></ol>     |
...
[^x402-decentralization]:
    ...
    In this case, the protocol is not failing by itself but in the way most people and agents, often unknowingly, use it. z402 can run on more blockchains, including the most decentralized: Ethereum.
